...
//                             firebaseSignUp(_textInputDisplayName.text.trim(), _textInputEmail.text.trim(),
//                                     _textInputPassword.text.trim())
//                                 .then(
//                               (value) {
//                                 if (value) {
//                                   ScaffoldMessenger.of(context)
//                                       .showSnackBar(SnackBar(content: Text("Signed up, check out your profile.")));
//                                   //firebaseSignOut();
//                                   context.beamToNamed('/dashboard');
//                                 } else {
//                                   ScaffoldMessenger.of(context).showSnackBar(SnackBar(
//                                       backgroundColor: Colors.red, content: Text("Cannot create your account.")));
//                                 }
//                               },
//                             );
//                           }
